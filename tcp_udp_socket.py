...
def send_and_receive_udp(address, udpport, cid):
    ...
    sent_msg = struct.pack('c??HHc', cid, ack, eom, data_remaining, init_length, init_msg)
    ...
    while 1:
        ...
        cid, ack, eom, data_remaining, length, msg = struct.unpack('c??HHc', recv_msg)
        print(msg)
        ...
        sent_msg = struct.pack('c??HHc', cid, ack, eom, data_remaining, length, msg)
